...
<section id="collections">
        ...
        <div class="row admin-email">
            <div class="col-md-12">
                <div class="email-wrapper">
                    ...
                    <h2>Please contact the user at <span class="user-email"></span> or in person to finalize the sale.</h2>
    ...
    <div class="remodal sender" data-remodal-id="send-message">
        ...
        <input id="user-email" type="text" placeholder="you@youremail.com">
