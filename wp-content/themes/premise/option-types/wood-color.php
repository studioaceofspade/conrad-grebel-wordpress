<div class="col-md-<?php echo $column_size; ?>">
    ...
    <div class="option-settings">
        ...
        <!-- SECTION: Step Data ===================================== 
             ======================================================== -->
        <?php if(get_field('does_this_skip_steps') && $termString != 'top-color') : ?>
        ...
        <div 
            class="texture-data" 
            data-texture-url="<?php the_field('texture_file_url'); ?>"
            data-texture-type="<?php the_field('paint_or_stain'); ?>">
        </div>
    </div>
</div>