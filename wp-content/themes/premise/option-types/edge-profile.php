<div class="col-md-<?php echo $column_size; ?>">
    ...
    <div class="option-settings">
        ...
        <!-- Single Pedestal -->
        <?php if(get_field('42"_round_top')) : ?>
            <?php foreach(get_field('42"_round_top') as $render) : ?>
            ...
            <?php endforeach; ?>
        <?php endif; ?>
        <?php if(get_field('48"_round_top')) : ?>
            <?php foreach(get_field('48"_round_top') as $render) : ?>
            ...
            <?php endforeach; ?>
        <?php endif; ?>
        <?php if(get_field('54"_round_top')) : ?>
            <?php foreach(get_field('54"_round_top') as $render) : ?>
            ...
            <?php endforeach; ?>
        <?php endif; ?>
        <?php if(get_field('60"_round_top')) : ?>
            <?php foreach(get_field('60"_round_top') as $render) : ?>
            ...
            <?php endforeach; ?>
        <?php endif; ?>
        <?php if(get_field('42"_apron')) : ?>
            <?php foreach(get_field('42"_apron') as $render) : ?>
            ...
            <?php endforeach; ?>
        <?php endif; ?>
        <?php if(get_field('48"_apron')) : ?>
            <?php foreach(get_field('48"_apron') as $render) : ?>
            ...
            <?php endforeach; ?>
        <?php endif; ?>
        <?php if(get_field('54"_apron')) : ?>
            <?php foreach(get_field('54"_apron') as $render) : ?>
            ...
            <?php endforeach; ?>
        <?php endif; ?>
        <?php if(get_field('60"_apron')) : ?>
            <?php foreach(get_field('60"_apron') as $render) : ?>
